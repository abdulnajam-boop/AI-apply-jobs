    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto flex max-w-md items-center px-6 py-14">
        <section className="w-full rounded-xl border border-border bg-white p-8 shadow-sm">
          <h1 className="text-2xl font-semibold text-slate-900">Create your Applisynai account</h1>
          <p className="mt-2 text-sm text-slate-500">UI-only auth flow for MVP. Sign-up actions route to dashboard for now.</p>

          <form className="mt-6 space-y-4">
            <input className="w-full rounded-lg border border-border px-3 py-2" type="text" placeholder="Full name" />
